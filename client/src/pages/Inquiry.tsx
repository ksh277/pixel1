...
export default function Inquiry() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0F1114] py-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        className="bg-white dark:bg-[#2A2A2A] text-black dark:text-white border dark:border-gray-600"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Select value={formData.category} onValueChange={(value) => handleInputChange('category', value)}>
                        <SelectTrigger className="bg-white dark:bg-[#2A2A2A] text-black dark:text-white border dark:border-gray-600">
