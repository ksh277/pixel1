      ...
      <div className="min-h-screen bg-white py-8" style={{ backgroundColor: '#ffffff' }}>
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center py-16">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4" style={{ color: '#111827' }}>
              {t({ ko: "장바구니가 비어 있습니다", en: "Your cart is empty" })}
            </h2>
            <p className="text-gray-600 mb-8" style={{ color: '#4B5563' }}>
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <Card className="bg-white border-gray-200" style={{ backgroundColor: '#ffffff' }}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="flex items-center" style={{ color: '#111827' }}>
                    <Checkbox
              ...
              <CardContent className="space-y-4">
                {cartItems.map((item) => (
                  <div key={item.id} className="flex items-center space-x-4 p-4 border border-gray-200 rounded-lg bg-white" style={{ backgroundColor: '#ffffff' }}>
                    <Checkbox
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-gray-900" style={{ color: '#111827' }}>{item.nameKo}</h3>
                      <p className="text-sm text-gray-600" style={{ color: '#4B5563' }}>{item.name}</p>
          ...
          <div className="lg:col-span-1">
            <Card className="sticky top-8 bg-white border-gray-200" style={{ backgroundColor: '#ffffff' }}>
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-gray-900" style={{ color: '#111827' }}>₩{subtotal.toLocaleString()}</span>
                </div>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-gray-900" style={{ color: '#111827' }}>
                    {shippingFee === 0 ? (
                      <span className="text-green-600" style={{ color: '#059669' }}>
                        {t({ ko: "무료", en: "Free" })}
                      </span>
                    ) : (
                ...
                {subtotal < 50000 && (
                  <div className="text-sm text-gray-600 bg-blue-50 p-3 rounded" style={{ color: '#4B5563', backgroundColor: '#EFF6FF' }}>
                    {t({ 
                ...
                <div className="flex justify-between text-lg font-bold">
                  <span style={{ color: '#111827' }}>{t({ ko: "총 결제 금액", en: "Total" })}</span>
                  <span className="text-blue-600" style={{ color: '#2563EB' }}>₩{total.toLocaleString()}</span>
                </div>
