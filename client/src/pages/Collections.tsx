...
export default function Collections() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#1F2D4A]">
      {/* Header Section */}
      <div className="bg-white dark:bg-[#1F2D4A] border-b border-gray-200 dark:border-gray-700">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {collections.map((collection) => (
            <Card key={collection.id} className="group hover:shadow-lg transition-shadow duration-300 overflow-hidden bg-white dark:bg-[#1F2D4A] border-gray-200 dark:border-gray-700">
