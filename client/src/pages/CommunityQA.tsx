    ...
    <div className="min-h-screen bg-white dark:bg-[#1F2D4A]">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                <div className="bg-white dark:bg-[#1F2D4A] rounded-2xl px-4 py-2 shadow-sm border border-blue-200 dark:border-gray-700">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col space-y-4 mb-6 md:flex-row md:items-center md:justify-between md:space-y-0">
          <div className="flex space-x-1 bg-gray-100 dark:bg-[#1F2D4A] rounded-lg p-1 mobile-tabs">
            {tabs.map((tab) => (
              <button
                key={tab}
                ...
                className={cn(
                  ...
                  activeTab === tab
                    ? "bg-white dark:bg-[#1F2D4A] text-blue-600 dark:text-blue-400 shadow-sm"
        ...
        <div className="space-y-4">
          {sortedPosts.map((post, index) => (
            ...
            >
              <Card className="hover:shadow-md transition-shadow cursor-pointer bg-white dark:bg-[#1F2D4A] border-gray-200 dark:border-gray-700">
