      ...
      >
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {rewardTiers.map((tier, index) => {
            ...
            return (
              <Card key={tier.id} className="relative group hover:shadow-lg transition-shadow duration-300 bg-white dark:bg-[#3F4C5F] border-gray-200 dark:border-gray-700">
        ...
        {/* Important Notice */}
        <motion.div variants={itemVariants} className="bg-gray-50 dark:bg-[#3F4C5F] rounded-lg p-6 border border-gray-200 dark:border-gray-700">
